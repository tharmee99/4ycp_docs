...
\begin{document}
	\makeTitlePage{Progress Report III}{ELEC0118 - Fourth Year MEng Project}
...
\begin{landscape}
	...
	\begin{table}[h!]
		...
		\begin{ganttchart}[
			...
			\ganttbar[progress=30]{BNN for TensorFlow}{2020-11-29}{2021-03-01}\\
			...
			\ganttbar[progress=50]{FPGA Tools \& Structures}{2020-11-09}{2021-03-14}\\
			%\ganttbar[progress=0]{}{2021-01-12}{2021-03-14}\\
			\ganttbar[progress=50]{Writing NN on HDL}{2020-11-15}{2021-03-21}\\
			%\ganttbar[progress=0]{}{2021-01-12}{2021-03-21}\\
			\ganttbar[progress=50]{Training COMs model}{2021-02-01}{2021-03-01}\\
